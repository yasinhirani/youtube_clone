...
const BottomNavigation = () => {
  ...
  return (
    <div className="flex items-center md:hidden fixed h-16 bottom-0 w-full bg-[#0f0f0f]">
      <ul className="flex justify-between items-center text-white space-x-5 mx-4 w-full">
        <li>
          <Link
            to="/"
            className={`${
